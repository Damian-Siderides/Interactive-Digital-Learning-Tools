    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/kmap">kmap</a>
          <a class="dropdown-item" href="/kmap2">kmap2</a>
          <a class="dropdown-item" href="/kmap3">kmap3</a>
          <a class="dropdown-item" href="/kmap4">kmap4</a>
        </div>
      </li>
      ...
      <li class="nav-item active dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/vhdl">vhdl</a>
          <a class="dropdown-item" href="/vhdl2">vhdl2</a>
          <a class="dropdown-item" href="/vhdl3">vhdl3</a>
          <a class="dropdown-item" href="/vhdl4">vhdl4</a>
          <a class="dropdown-item" href="/vhdl5">vhdl5</a>
        </div>
      </li>
      ...
      <!-- <li class="nav-item active dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="/fsm">fsm</a>
          <a class="dropdown-item" href="/fsm2">fsm2</a>
          <a class="dropdown-item" href="/fsm3">fsm3</a>
...
<!-- Big image of something on homepage -->

{{!base}}

<!-- maybe we have to change this later -->
<!-- </center> -->
</div>
</main>
