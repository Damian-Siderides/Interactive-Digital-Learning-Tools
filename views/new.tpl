...
%import sqlite3
		...
		<div class="jumbotron">Here you can try to write vhdl code from scratch. When you are done you can compare your answer to the template code.</div>

		<div class='parent inline-flex-parent'>
			<div class='child'>
				<textarea class = "jumbotron" rows="15" cols="50"></textarea>
			</div>
			<div class="child">
...
// add full adder and other circuits, latch flipflop counter
		...
		% # error with below line even when commented out with //
