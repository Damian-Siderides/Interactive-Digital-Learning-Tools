...
%end
	...
	<form action="/vhdl5" method="post">
                ...
                <input name="guess" value="multiplexer" type="submit" class="btn btn-outline-primary btn-lg"/>
                <input name="guess" value="4 multiplexer" type="submit" class="btn btn-outline-primary btn-lg"/>
                <input name="guess" value="bus multiplexer" type="submit" class="btn btn-outline-primary btn-lg"/>
                <br><br>
                <input name="guess" value="other bus multiplexer" type="submit" class="btn btn-outline-primary btn-lg"/>
                <input name="guess" value="single flip flop" type="submit" class="btn btn-outline-primary btn-lg"/>
                <input name="guess" value="something" type="submit" class="btn btn-outline-primary btn-lg"/>   
                ...
                <input name="guess" value="next state bloated" type="submit" class="btn btn-outline-primary btn-lg"/>
                <input name="guess" value="next state" type="submit" class="btn btn-outline-primary btn-lg"/>
                <input name="guess" value="finite state machine" type="submit" class="btn btn-outline-primary btn-lg"/>
                <br><br>
                <input name="guess" value="crosswalk" type="submit" class="btn btn-outline-primary btn-lg"/>
