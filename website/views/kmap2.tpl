...
<form action="/kmap2" method="post">
                ...
                <input id="a" name="guess" value="a" type="submit" class="btn btn-light"/>
                <input id="b" name="guess" value="b" type="submit" class="btn btn-light"/>
                <br><br>
                <input id="c" name="guess" value="c" type="submit" class="btn btn-light"/>
                <input id="d" name="guess" value="d" type="submit" class="btn btn-light"/>
